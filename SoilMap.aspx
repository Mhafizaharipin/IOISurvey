<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SoilMap.aspx.cs" EnableEventValidation="false" Inherits="SoilMap" MasterPageFile="~/MasterPage.master" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="margin-top:2%;">
        <h2>SOIL RECONNAISSANCE MAP</h2>
        <asp:DataList ID="DataList" runat="server" RepeatColumns="4" CellPadding="8" OnItemDataBound="DataList_ItemDataBound">
            <ItemTemplate>
                <table>
                    <tr>
                        <td>
                            <asp:ImageButton runat="server" ID="imageUrl" OnClientClick="setTarget();" OnClick="imageUrl_Click" Width="250px" Height="150px" ImageUrl='<%#Eval("planNo_image") %>' />
                        </td>
                    </tr>
                    <tr>
